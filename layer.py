...
class KernelConvTranspose2d(torch.nn.ConvTranspose2d):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, padding=0, output_padding=0,
                 groups=1, bias=None, dilation=1, kernel_fn=PolynomialKernel, padding_mode='zeros'):
        '''
        Follows the same API as torch ConvTranspose2d except kernel_fn.
        kernel_fn should be an instance of the above kernels.
        '''
        super(KernelConvTranspose2d, self).__init__(in_channels, out_channels, 
